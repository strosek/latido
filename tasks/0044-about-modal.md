...
philosophy and basic usage, so a first-time visitor quickly understands what UltradianDrift is and how
to use it.
...
- Opens a modal (reuse the overlay/dialog system in `dialogs.ts`) titled "About UltradianDrift".
- Content covers:
